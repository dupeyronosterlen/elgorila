...
- **Index.html** y **boletos.html** ahora tienen el mismo header
- Botón "Giras" reemplaza "Boletos" en Index.html
- Botón "Giras" redirige a `https://elgorila.com.mx`
- Header con altura de 85px (1/3 más grande que antes)
